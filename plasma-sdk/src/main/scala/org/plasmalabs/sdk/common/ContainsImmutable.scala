...
import org.plasmalabs.sdk.models.box.{Attestation, Box, Challenge, FungibilityType, Lock, QuantityDescriptorType, Value}
...
object ContainsImmutable {
  ...
  trait Instances {
    ...
    implicit val signatureKesSumImmutable: ContainsImmutable[org.plasmalabs.consensus.models.SignatureKesSum] =
      v =>
        v.verificationKey.immutable ++
        v.signature.immutable ++
        v.witness.immutable

    implicit val signatureKesProductImmutable: ContainsImmutable[org.plasmalabs.consensus.models.SignatureKesProduct] =
      v =>
